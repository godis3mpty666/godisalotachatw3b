...
def _detect_app_dir() -> str:
    # In plugin builds this file lives in <app>/plugins/spotis3mptify.
    # Runtime data belongs in <app>/data/spotis3mptify, never inside plugins.
    try:
    ...
    try:
        ...
        if os.path.basename(parent).lower() == "plugins":
